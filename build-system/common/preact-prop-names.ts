...
function objectFlip<K extends string|number|symbol, V extends string|number|symbol>(obj: Record<K, V>): Record<V, K> {
...
export const ATTRIBUTES_REACT_TO_PREACT = {
  ...DOM_ATTRIBUTES_REACT_TO_PREACT,
  ...SVG_ATTRIBUTES_REACT_TO_PREACT,
};

export const ATTRIBUTES_PREACT_TO_REACT = objectFlip(ATTRIBUTES_REACT_TO_PREACT);
